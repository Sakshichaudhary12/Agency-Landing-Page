...
const ContactUs = () => {
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "1be10744-69d8-487d-8f6d-35a0cadd3ed2");
  ...
  return (
    <motion.div
      ...
      id="contact-us"
      className="flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-32
    ...
    >
      ...
      >
        <div>
          ...
          <div className="flex p-3 rounded-lg border border-gray-300 dark:border-gray-600">
