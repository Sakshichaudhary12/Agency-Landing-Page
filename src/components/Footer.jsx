...
const Footer = ({ theme }) => {
  return ( 
    ...
    viewport={{once:true}}
    className="bg-white dark:bg-gray-900 pt-10 pb-5 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40">
      {/* Footer Top */}
      ...
      viewport={{once:true}}
        className="space-y-5 text-sm text-gray-700 dark:text-gray-400">
          <img src={theme === "dark" ? assets.logo_dark : assets.logo}
            alt="logo" className="w-32 sm:w-44" />
    ...
    <div className="flex gap-2 text-sm">
      ...
      viewport={{once:true}}
        className="pb-6 text-sm text-gray-500 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p>Copyright 2025 © agency.io Sakshi - All Rights Reserved.</p>
